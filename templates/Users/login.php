	...
	<div class="card bg-body-tertiary border-0 shadow mb-4">
		<div class="card-body">
			<div class="my-4 text-center">
				<h2 style="color: #cccccc; text-align: center; font-weight: bold;">WELCOME TO INTERNHUB</h2>
				<h3 class="slogan" style="font-size: 1rem; color:#ffeb3b; font-weight: normal; margin-top: 5px;">
    			Start Your Path to Success with InternHub!</h3><br>
