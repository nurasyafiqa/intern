    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <li class="menu-item">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-file-lines"></i> Applications'), ['controller' => 'Applications', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-building-columns"></i> Companies'), ['controller' => 'Companies', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                <li class="menu-item">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-user-graduate"></i> Students'), ['controller' => 'Students', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                <li class="menu-item">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-chalkboard-user"></i> Supervisors'), ['controller' => 'Supervisors', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                <?php } ?>
            <?php } ?>
        </ul>
