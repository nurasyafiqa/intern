                ...
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            ...
                            <th><?= __('Company Address1') ?></th>
                            <th><?= __('Company Address2') ?></th>
                            <th><?= __('Postcode') ?></th>
                            <th><?= __('City') ?></th>
                            <th><?= __('State') ?></th>
                        ...
                        <tr>
                            ...
                            <td><?= h($applications->company_address1) ?></td>
                            <td><?= h($applications->company_address2) ?></td>
                            <td><?= h($applications->postcode) ?></td>
                            <td><?= h($applications->city) ?></td>
                            <td><?= h($applications->state) ?></td>
                            <td><?= h($applications->contact_person) ?></td>
