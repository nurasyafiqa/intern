	...
	<div class="table-responsive">
		...
		?>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('pa_phone') ?></th>
                    <th><?= $this->Paginator->sort('pa_email') ?></th>
                    <th><?= $this->Paginator->sort('pa_position') ?></th>
            ...
            <tbody>
				...
				<td><?php echo $counter++ ?></td>
                    ...
                    <td><?= $application->hasValue('supervisor') ? $this->Html->link($application->supervisor->name, ['controller' => 'Supervisors', 'action' => 'view', $application->supervisor->id]) : '' ?></td>
                    <td><?= $application->hasValue('company') ? $this->Html->link($application->company->name, ['controller' => 'Companies', 'action' => 'view', $application->company->id]) : '' ?></td>
                    <td><?= h($application->application_date) ?></td>
                    <td><?= h($application->start_date) ?></td>
                    <td><?= h($application->end_date) ?></td>
                    <td><?= h($application->pa_name) ?></td>
                    <td><?= h($application->pa_phone) ?></td>
                    <td><?= h($application->pa_email) ?></td>
                    <td><?= h($application->pa_position) ?></td>
